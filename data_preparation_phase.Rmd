...
We just do an example of computing the reference limit for the Area attribute, but of course we will have to do this for the other attributes.


Example of computing the Reference limit for the Area : 
